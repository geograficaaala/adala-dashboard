...
TAB_CONFIG = {
    "encabezado_raw.csv": {
        "range": "01_Encabezado!A4:C30",
        "mode": "fixed_header",
        "header": ["campo", "valor", "nota"],
    },
    "modulos_raw.csv": {
        "range": "02_Modulos!A4:C30",
        "mode": "fixed_header",
        "header": ["modulo", "activo_este_mes", "nota"],
    },
    "capacitaciones_raw.csv": {
        "range": "03_Capacitaciones!A2:AZ1200",
        "mode": "first_row_header",
    },
    "asistencias_raw.csv": {
        "range": "04_Asistencias!A2:AZ1200",
        "mode": "first_row_header",
    },
    "estudios_raw.csv": {
        "range": "05_Estudios!A2:AZ1200",
        "mode": "first_row_header",
    },
    "pirdes_raw.csv": {
        "range": "06_PIRDES!A2:AZ1200",
        "mode": "first_row_header",
    },
    "reuniones_raw.csv": {
        "range": "07_Reuniones!A2:AZ1200",
        "mode": "first_row_header",
    },
}
